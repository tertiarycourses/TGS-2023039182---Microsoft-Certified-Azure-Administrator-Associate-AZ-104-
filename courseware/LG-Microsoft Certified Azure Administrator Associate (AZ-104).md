...
![AZ-104 course roadmap: five exam domains and the 26 aligned labs.](assets/az104-domain-roadmap.png)
*AZ-104 course roadmap: five exam domains and the 26 aligned labs.*
...
![Identity and governance model: tenant identities, RBAC scopes, Policy and cost controls.](assets/az104-identity-governance.png)
*Identity and governance model: tenant identities, RBAC scopes, Policy and cost controls.*
...
![Storage administration model: redundancy, access controls, data services and lifecycle management.](assets/az104-storage-access.png)
*Storage administration model: redundancy, access controls, data services and lifecycle management.*
...
![Compute decision map: infrastructure as code, VMs, scale sets, containers and App Service.](assets/az104-compute-options.png)
*Compute decision map: infrastructure as code, VMs, scale sets, containers and App Service.*
...
![Virtual networking model: VNets, subnets, security controls, endpoints, DNS and load balancing.](assets/az104-networking-map.png)
*Virtual networking model: VNets, subnets, security controls, endpoints, DNS and load balancing.*
...
![Monitoring and maintenance loop: observe, diagnose, protect and recover Azure resources.](assets/az104-monitor-maintain.png)
*Monitoring and maintenance loop: observe, diagnose, protect and recover Azure resources.*
